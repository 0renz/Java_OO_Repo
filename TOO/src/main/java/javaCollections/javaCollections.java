...
public class javaCollections {
    ...
    //Usar object para aceitar todos os tipos!
    ...
    public javaCollections(Integer tipo) {
        ...
        for (int i : list) {
            System.out.println(i + ": " + list);//List possibilita a recuperacao pelo indice.
        }
        System.out.println("Contem o elemento com o valor 150: " + list.contains(3));
    }
    ...
    public javaCollections(String tipo) {
        ...
        st.add("Japão");
        st.add("Brasil");
        // Classificação por ordem alfabética + remoção dos repetidos (no caso, Brasil)
    ...
    public void metodoHashmap() {
        ...
        System.out.println("chave uz: " + mp.get("uz")); // get busca sempre pela chave
    ...
    public void metodoClassificacao() {
        ...
        Collections.sort(list);//classificacao com base na método compareTo (lá em aluno)               
